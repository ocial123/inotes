<?php
require('C:/xampp2/htdocs/prggm/iNotes-main/fpdf.php');
...
if (isset($_POST['save_as_pdf'])) {
    ...
    while ($row = mysqli_fetch_row($result)) {
        $pdf->Cell(0, 10, "Title: " . $row[1], 0, 1);
        $pdf->Cell(0, 10, "Description: " . $row[2], 0, 1);
        $pdf->Ln();
    }
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://carrrdof.carrd.co/">Contact Us</a>
          </li>
        </ul>
        <!-- Search bar start -->
  ...
  <div class="container my-4">
    ...
    <form action="" method="post">
      ...
      <input type="submit" name="save_as_pdf" class="btn btn-primary" value="Save as PDF"></input>
    </form>
    <!-- input area end -->
  </div>
  <div class="container my-4">
      ...
      if (!(isset($_POST['search_name']))) {
        ...
        while ($row = mysqli_fetch_row($result)) {
          echo ("<tbody>
            ...
            <td>$row[2]</td>
            <td>&nbsp;&nbsp; 
            <button class='btn btn-sm btn-danger my-1' onclick='deleteit(" . $row[0] . ")'>Delete</button></td>
            </tr>
            </tbody>");
          $v++;
        }
